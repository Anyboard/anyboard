...
void loop() {
    ...
    Serial.println();
//    if (rgb_sensor.ct > 3765 && rgb_sensor.ct < 3950)
//    {
//      current_sector_ID = 8;
//      Serial.print("Grey");
//    }
//    else 
    if (rgb_sensor.ct > 2500 && rgb_sensor.ct < 2700)
    {
        current_sector_ID = 3;
        Serial.print("Yellow");
    }
...
//        Serial.print("White");        
//    }
    else if (rgb_sensor.ct > 4350 && rgb_sensor.ct < 4550)
    {
        current_sector_ID = 4;
        Serial.print("Green");
    }
    else if (rgb_sensor.ct > 4000 && rgb_sensor.ct < 4350)
    {
        current_sector_ID = 5;
        Serial.print("Purple");
    }
//    else if (rgb_sensor.ct > 5880 && rgb_sensor.ct < 5950)
//    {
//        current_sector_ID = 1;
//        Serial.print("White blue");
//    }
    else if (rgb_sensor.ct > 5500 && rgb_sensor.ct < 6200)
    {
        current_sector_ID = 6;
        Serial.print("Dark blue");
    }
    else if (rgb_sensor.ct > 3700 && rgb_sensor.ct < 4000)
    {
        current_sector_ID = 2;
        Serial.print("Black");
    }
