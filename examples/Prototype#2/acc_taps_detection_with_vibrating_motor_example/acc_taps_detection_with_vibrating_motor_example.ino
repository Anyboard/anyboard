// Example code for tap detection using accelerometer ADXL345 a vibrating motor and a RFduino
...
// Initiate the vibrating motor
Vibrating_Motor buzz = Vibrating_Motor(VIBRATING_M_PIN); // Connected on pin 2
